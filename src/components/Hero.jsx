...
import cvFile from '../images/EL_MERSY_CV.pdf'; // Assure-toi que le chemin est correct
    ...
    <section className="relative bg-white min-h-screen flex items-center justify-between px-10 md:px-20">
      ...
      <div className="z-10 max-w-xl">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <button className="bg-gradient-to-r from-pink-500 to-red-400 text-white px-6 py-2 rounded-full shadow-md hover:scale-105 transition">
            <a href={cvFile} download="CV-Zahira-Elmersy.pdf">
              Télécharger CV
            </a>
          </button>
        </div>
